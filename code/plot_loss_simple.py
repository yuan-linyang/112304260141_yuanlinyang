...
def plot_training_loss():
    ...
    plt.plot(epochs, train_losses, 'b-o', label='Training Loss', linewidth=2, markersize=8, color='#1f77b4')
    plt.plot(epochs, val_losses, 'r-s', label='Validation Loss', linewidth=2, markersize=8, color='#d62728')
    ...
    for i, (tl, vl) in enumerate(zip(train_losses, val_losses)):
        plt.text(i + 1, tl + 0.015, f'{tl:.3f}', ha='center', va='bottom', fontsize=8, color='blue', alpha=0.7)
        plt.text(i + 1, vl - 0.025, f'{vl:.3f}', ha='center', va='top', fontsize=8, color='red', alpha=0.7)
